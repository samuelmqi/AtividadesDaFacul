...
public class CampeonatoBrasileiro {// 4 criar Classe Principal CampeonatoBrasileiro
	...
	public static void main(String[] args) {
		...
		// 4.2) Encontrar o time do estado desejado, interagir com o usuário para
		...
		// 4.3) Criar uma coleção de times-> Utilizar a interface List -> Implementação
		// ArrayList
		// Incluir 10 times
		...
		// Interagir com o usuário, via JOptionPane e perguntar qual o seu time do
		// coração
		...
		// Se o time existir, informar a mensagem "O seu time do coração esta na
		// colocação" + colocação.
		...
		// Se o time não existir, informar a mensagem: "Time não participando do
		// Brasileirão!!!"
		else {
		...
		// 4.5) Criar uma coleção de times -> Utilizar a interface Set
		Set<String> colecaoTimesSet = new HashSet<>();

		// Criando um objeto do tipo Time com o nome da variável atleticoMineiro
		Time atleticoMineiroSet = new Time();
		atleticoMineiroSet.nome = "Atlético Mineiro";

		// Incluindo o objeto q está na variável atleticoMineiro dentro da lista
		...
		// Puxar pontuação metodos ganhar, perder e empatar
		...
		// Imprimir na tela o time da 1ª colocação com o metodo colocacao
		...
		// Retirar da coleção o time da última colocação
		// Remove o objeto que está na variável de referência cruzeiro
		colecaoTimesSet.remove(cruzeiroSet.nome);
		colecaoTimesSet.remove(santosSet.nome);

		// Imprimir na tela sem o ultimo da colocação
